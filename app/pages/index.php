...
<div class="row">
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        ...
        <div class="card-header p-3 pt-2">
            ...
            <p class="text-sm mb-0 text-capitalize">Make an order</p>
    ...
    <div class="col-xl-3 col-sm-6">
        ...
        <div class="card-header p-3 pt-2">
            ...
            <div class="text-end pt-1">
            <p class="text-sm mb-0 text-capitalize">Schedule a delivery</p>
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        ...
        <div class="card-header p-3 pt-2">
            ...
            <div class="text-end pt-1">
            <p class="text-sm mb-0 text-capitalize">Discount an item</p>
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        ...
        <div class="card-header p-3 pt-2">
            ...
            <div class="text-end pt-1">
            <p class="text-sm mb-0 text-capitalize">Manage your stock</p>
